...
class MyAccountController extends Controller
{
    ...
    public function myAccount()
    {
        ...
        return view('mobile.accounts.my_account_settings', compact('user', 'divisions', 'districts', 'upazilas', 'userAddress'));
    }

    public function myAccountSettingsUpdate(Request $request)
    {
    ...
    // Ajax Methods all below

    public function getDistrictByDivisionIdViaAjax($divisionId)
    {
        $districts = DB::table('districts')->where('division_id', $divisionId)->select('name', 'id')->get();
        return response()->json($districts);
    }

    public function getUpazilaByDistrictIdViaAjax($districtId)
    {
