				...
				<div class="middle_content_wrapper">
					<section class="page_content">
						...
						<div class="panel mb-0">
							...
							<form action="{{route('admin.warranty.multiplesoftdelete')}}" method="post">
						     @csrf
		                                      ...
		                                      <td>{{Str::limit($data->w_ans,100)}}</td>
		                                       ...
		                                       <td>
		                                       	@if($data->status==1)
		                                            ...
		                                            <a id="delete" href="{{url('admin/warranty/softDelete/'.$data->id)}}" class="btn btn-danger btn-sm text-white" data-toggle="tooltip" data-placement="right" title="Delete" data-original-title="Delete"><i class="far fa-trash-alt"></i></a>
		                                       </td>
		                                  </tr>
		                        		@endforeach
		                              </tbody>
