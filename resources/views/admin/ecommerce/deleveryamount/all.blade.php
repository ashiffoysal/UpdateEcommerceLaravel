					...
					<section class="page_content">
						...
						<div class="panel mb-0">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="panel_title">
											<span class="panel_icon"><i class="fas fa-border-all"></i></span><span>Update Delevery Amount</span>
										</div>
									</div>
							...
							<div class="panel_body">
								<form class="" action="{{route('admin.deleveryamount.submit')}}" method="post">
									@csrf

								<div class="form-group row">
				 			    <label for="inputEmail3" class="col-sm-3 col-form-label text-right">Inside Dhaka(৳)</label>
				 			    <div class="col-sm-6">
				 			      <input type="number" class="form-control" name="insidedhaka" value="{{$amount->insidedhaka}}">
				 			      <input type="hidden" name="id" value="{{$amount->id}}">
				 			    </div>
				 			  </div>
								<div class="form-group row">
				 			    <label for="inputEmail3" class="col-sm-3 col-form-label text-right">OutSide Dhaka(৳)</label>
				 			    <div class="col-sm-6">
				 			      <input type="number" class="form-control" name="outsidedhaka" value="{{$amount->outsidedhaka}}">
				 			    </div>
				 			  </div>
								<div class="form-group row">
