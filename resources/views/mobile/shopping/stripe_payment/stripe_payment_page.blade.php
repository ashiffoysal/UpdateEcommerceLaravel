...
<header class="bar bar-nav ">
    ...
    <h1 class="title">International Dabit Or Cradit Card</h1>
</header>
<!-- //End Bar Nav -->
        ...
        <div class="row">
            <div id="content" class="col-xs-12">
                ...
                <div style="height:50vh;" class="stripe_payment_section">
                        ...
                        <div class="payment_heading_section">
                           <h4 style="margin-right:27px;"><strong>Dabit Or Cradit Card Payment</strong></h4>
                        </div>
                        ...
                        <div class="sripe_payment">
                            <div class="payment-form">
                                {{-- --}}
                                <form action="{{ route('mobile.payment.stripe.submit', $orderInfo->payment_secure_id) }}"
                                    class="stripe_form" method="POST" id="payment-form">
                                    @csrf
                                    <div class="form-group">
                                        <label for="">
                                            <strong>Card Holder Name</strong>
                                        </label>
                                        <input type="text" name="holder_name" id="holder_name" class="form-control name_field" placeholder="John Doa"
                                            aria-describedby="helpId">
                                        <span id="helpId card-errors"
                                            class="text-error">{{ $errors->first('holder_name') }}</span>
                                    </div>
                                    ...
                                    <div class="hidden_field">
                                        ...
                                        <input type="hidden" name="total_quantity"
                                            value="{{ $orderInfo->total_quantity }}">
