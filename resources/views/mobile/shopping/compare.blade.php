      ...
      <div class="container">
			...
			<!-- //Begin Main Content -->
								<div class="row">
										...
										<div class="panel panel-default">
											<div class="panel-heading">
												<h4 class="panel-title"><i class="fa fa-retweet"></i> Compare Product</h4>
											</div>
                              ...
                              @foreach($com as $wish)
                                  ...
                                  <a href="{{url('mobile/compare/delete/'.$wish->id)}}" title="Remove" class="delete btn btn-danger btn-sm"><i class="fa fa-times"></i></a></td>
                                </td>
															</tr>
                              @endforeach
														</tbody>
