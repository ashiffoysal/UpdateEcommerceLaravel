                      ...
                      <div class="table_cell">
                        <fieldset>
                          ...
                          <ul class="checkboxes_list">
                              ...
                              <li>
                                <input type="radio" class="re_subcategory_id" value="{{ $re_subcategory->id }}" name="re_sub_category_id" id="{{ $re_subcategory->resubcate_name }}">
...
<script>
    $(document).ready(function() {
        $('.filter_reset').on('click', function(){
            $('.re_subcategory_id').prop('checked', false);
