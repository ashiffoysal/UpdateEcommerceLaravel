                ...
                <div class="tab-content">
                    <div id="home" class="tab-pane form-login fade active in">
                        ...
                        <div class="well col-sm-12">
                            ...
                            <form action="{{route('checkout.mobile.login')}}" method="post"
                            ...
                            <div class="social_login icons-social">
                                <div class="list-inline">
                                    ...
                                    <a title="Google+" href="{{ route('google.login') }}" target="_blank">
                    ...
                    <div id="menu1" class="tab-pane fade in">
                        ...
                        <div id="content" class="col-xs-12">
                            ...
                            <form action="{{ route('mobile.register') }}" method="post" enctype="multipart/form-data"
                                    ...
                                    <div class="form-group required">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="username" value="{{old('username')}}"
                                                placeholder="Enter Your Name" id="input-firstname" class="form-control">
                                ...
                                <div class="buttons">
                                    <div class="pull-right">I have read and agree to the <a href="#"
                                            class="agree"><b>Terms And Conditions</b></a>
