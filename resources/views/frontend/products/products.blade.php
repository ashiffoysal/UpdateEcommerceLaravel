...
<div id="main_content">
    ...
    <div class="breadcrumbs"
        style="background: url({{asset('public/uploads/sitebanner/'.$maiimage->image)}}) no-repeat center top;">
        <div class="container">
    ...
    @else
    <div class="breadcrumbs"
        style="background: url({{asset('public/frontend/image/breadcrumbs.jpg')}}) no-repeat center top;">
        <div class="container">
            <div class="title-breadcrumb">
                {{$category->cate_name}}
            </div>
    ...
    <div class="container product-detail">
        <div class="row">
                                                ...
                                                <div class="so-option-container">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control"
                                                            data-id="{{ $category->id }}" name="search_field"
                                                            id="search_field">
            ...
            @php
            $cid=$category->id;
            $newban_image=App\CategoryBanner::where('section',2)->where('category_id',
            $cid)->orderBy('id','DESC')->limit(1)->first();
            @endphp
            <div id="content" class="col-md-9 col-sm-12 col-xs-12">
                <div class="module banners-effect-9 form-group">
                    <div class="banners">
                        ...
                        @if($main_image)
                        <div>
                            <a href="{{$main_image->link}}"><img
                                    src="{{asset('public/uploads/sitebanner/'.$main_image->image)}}"></a>
                        </div>
                        @else
                ...
                <div class="products-category">
                    ...
                    <div class="all_category_wise_product">
                        <div class="products-category">
                            ...
                            <div class="products-list grid row number-col-3 so-filter-gird search_main_top"
                                id="search_main_top">
                                <!-- category product -->
                                @php
                                $products =
                                App\Product::where('is_deleted',0)->where('cate_id',$category->id)->orderBy('id','DESC')->paginate(6);
                                @endphp
                                            ...
                                            <div class="right-block">
                                                <div class="caption">
                                                    ...
                                                    <div class="total-price">
                                                        @php
                                                        $flashdealdetail =
                                                        App\FlashDealDetail::where('product_id',$product->id)->get();
                                                        @endphp
                                                        <div class="price price-left">
                                                            ...
                                                            <span class="price-new">
                                                                ...
                                                                ৳ {{$product->product_price - $row->discount}} </span>
                                                            <span class="price-old">৳ {{$product->product_price}}
                                                            </span>
                                                            @else
                                                            <span class="price-new">
                                                                ৳ {{$product->product_price -$productdiscount}} </span>
                                                            <span class="price-old">৳ {{$product->product_price}}
                                                            </span>
                                                            @endif
                                                            @endforeach
                                                    ...
                                                    <div class="list-block hidden">
                                                        ...
                                                        <form class="option-choice-form" onclick="producttocart(this);">
                                                            ...
                                                            <button class="addToCart" type="button"
                                                                data-toggle="tooltip" title=""
                                                                onclick="cart.add('30 ', '1 ');productaddtocart(this);"
                                                                data-original-title="Add to Cart "><span>Add to Cart
                                                                </span></button>
                                                            @endif
                                                ...
                                                <div class="button-group">
                                                    <div class="button-inner so-quickview">
                                                        ...
                                                        @else
                                                        <a href="{{route('login')}}" class="compare btn-button"><i
                                                                class="fa fa-heart"></i></a>
                                                        @endif

                                                        <button class="compare btn-button compareproduct" type="button"
                                                            id="compareproduct" value="{{$product->id }}"><i
