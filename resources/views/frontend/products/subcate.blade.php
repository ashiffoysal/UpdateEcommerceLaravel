...
<div id="main_content">
    ...
    <div class="container product-detail">
        <div class="row">
                                                ...
                                                <div class="so-option-container">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control"
                                                            data-id="{{ $subcate->id }}" name="search_field"
                                                            id="search_field">
            ...
            {{-- Sub-Category Page Sidebar ended --}}
                                    ...
                                    <div class="product-item-container">
                                        <div class="left-block">
                                            <div class="product-image-container  second_img  ">
                                                <ahref="{{url('product/'.$product->slug.'/'.$product->id)}}"
                                                ...
                                                <div class="total-price">
                                                    ...
                                                    <div class="price price-left">
                                                        ...
                                                        <span class="price-new">
                                                            ...
                                                            class="price-old">৳ {{$product->product_price}}
                                                        </span>
                                                        @else
                                                        <span class="price-new">
                                                ...
                                                <div class="button-inner so-quickview">
                                                    ...
                                                    <form class="option-choice-form" onclick="subcataddtocart(this);">
                                                        ...
                                                        <button class="addToCart btn-button" type="button"
                                                            data-toggle="tooltip" title="" onclick="cart.add('114');"
