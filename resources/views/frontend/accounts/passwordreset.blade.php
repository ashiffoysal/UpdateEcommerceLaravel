...
<div class="ps-page--my-account">
        ...
        <div class="ps-my-account">
            ...
            @if(Session::has('errorMsg'))
                    ...
                    @endif
                    <form class="ps-form--account ps-tab-root" action="{{route('customar.reset.password')}}" method="post">
                        @csrf
                    <div class="ps-tabs">
                        ...
                        <div class="ps-form__content">
                                    ...
                                    <div class="form-group form-forgot">
                                        <input class="form-control" name="password_confirmation" type="password" placeholder="Confirm Passowrd">
                                    </div>
