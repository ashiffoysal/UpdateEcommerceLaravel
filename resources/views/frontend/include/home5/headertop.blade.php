<header class="header header--standard header--market-place-2" data-sticky="true">
        ...
        <div class="header__content">
            <div class="container">
                <div class="header__content-left"><a class="ps-logo" href="index.html"><img src="{{asset('public/frontend')}}/img/logo.png" alt=""></a>
        ...
        <nav class="navigation">
            <div class="container">
                <ul class="menu menu--market-2">
                    ...
                    <li><a href="shop-default.html">Book &amp; More</a>
                    </li>
                </ul>
            </div>
        </nav>
