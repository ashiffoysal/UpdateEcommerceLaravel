    <div class="ps-promotion-kids">
        <div class="container"><a href="#"><img src="{{asset('public/frontend')}}/img/promotions/home-kids/top.jpg" alt=""></a></div>
    </div>
    <header class="header header--standard header--kids" data-sticky="true">
        <div class="header__top">
            <div class="container">
                <div class="header__left"><a class="ps-logo" href="index.html"><img src="{{asset('public/frontend')}}/img/logo-kids.png" alt=""></a>
        ...
        <nav class="navigation">
            <div class="container">
                <div class="navigation__left">
                    <div class="menu--product-categories">
                        <div class="menu__toggle active"><i class="icon-menuw"></i><span> Shop by Department</span></div>
                        <div class="menu__content">
                            <ul class="menu--dropdown">
