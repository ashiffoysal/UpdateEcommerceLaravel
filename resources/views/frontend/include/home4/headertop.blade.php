<div class="ps-block--promotion-header bg--cover" data-background="{{asset('public/frontend')}}/img/promotions/header-promotion.jpg">
        <div class="container">
        ...
        <div class="header__content">
            <div class="container">
                <div class="header__content-left">
                    ...
                    </div><a class="ps-logo" href="index.html"><img src="{{asset('public/frontend')}}/img/logo.png" alt=""></a>
                </div>
